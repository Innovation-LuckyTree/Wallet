...
public class GetPagedAccountTransactionsQueryHandler : IRequestHandler<GetPagedAccountTransactionsQuery, AccountDto>
{
    private readonly IWalletDbContext _walletDbContext;

    public GetPagedAccountTransactionsQueryHandler(IWalletDbContext walletDbContext)
    {
    ...
    public async Task<AccountDto> Handle(GetPagedAccountTransactionsQuery request, CancellationToken cancellationToken)
    {
        ...
        var transactions = accountTransactions.Select(o => new AccountTransactionDto
        {
            Id = o.Id,
